...
{
	if (this->priorityAnimation) //Si il y a une animation prioritaire
	{
		if (this->priorityAnimation == this->animations[key])
		{
			...
			//Si l'animation prioritaire est terminée on la supprimez-la
	...
	{
		//Si c'est une animation prioritaire on la défini
		if (priority)
		{
