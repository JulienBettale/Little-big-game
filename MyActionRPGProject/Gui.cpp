...
{
	/*
-    * Convertis la valeur en pourcentage en pixel de la résolution actuelle sur l'axe X.
-    * @param       float perc              la valeur en pourcent
-    * @param       sf::VideoMode& vm       le VideoMode actuel de la fenêtre (résolution)
-    * @return      float                   le calcul de la valeur en pixel
	 */
...
{
	/*
	 * Convertis la valeur en pourcentage en pixel de la résolution actuelle sur l'axe Y.
	 * @param		float perc				la valeur en pourcent
	 * @param		sf::VideoMode& vm		le VideoMode actuel de la fenêtre (résolution
	 * @return		float					le calcul de la valeur en pixel
	 */
...
{
	/*
	 * Calcule la taille du texte en utilisant la résolution actuelle et une constante.
-    * @param       sf::VideoMode& vm       le VideoMode actuel de la fenêtre (résolution)
-    * @param       unsigned modifier       utilisé pour modifier la taille des caractères d'une manière plus personnalisée
-    * @return      unsigned                le calcul de la valeur du caractère
	 */
	...
	: font(font), showList(false), keytimeMax(1.f), keytime(0.f)
{
	...
	this->activeElement = new gui::Button(
		x, y, width, height, //Position du bouton + taille : x / y / width / height
		&this->font, list[default_index], 50,
	...
	for (unsigned i = 0; i < nrOfElements; i++)
	{
		this->list.push_back(
			new gui::Button(
				x, y + ((i+1) * height), width, height, //Position du bouton + taille : x / y / width / height
				&this->font, list[i], 50,
				sf::Color(20, 20, 20, 200), sf::Color(90, 90, 90, 200), sf::Color(0, 0, 0, 200), //Background du bouton idle / hover / active
				sf::Color::Transparent, sf::Color::Transparent, sf::Color::Transparent,
				sf::Color::Transparent, sf::Color::Transparent, sf::Color::Transparent,
